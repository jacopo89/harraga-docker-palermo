...
var ruoli = [ 'CPA', 'RESP_SEC_ACC', 'TUTORE', 'COMUNE_PALERMO', 'REF_LEGALE',
...
var CREATOR_ROLE = ['COMUNE_PALERMO' ];
// JACOPO : ELIMINAZIONE DEI RUOLI CPA E RESP_SEC_ACC DA INSTITUTIONAL_ROLE
var INSTITUTIONAL_ROLE = ['COMUNE_PALERMO', 'ASP',  'ITASTRA', 'CPIA', 'USSM', 'GARANTE' ];
