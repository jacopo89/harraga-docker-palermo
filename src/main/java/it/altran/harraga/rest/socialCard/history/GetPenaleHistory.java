...
public class GetPenaleHistory extends ActionSupport implements ServletRequestAware  {
    ...
    public String execute() {  	
    	...
    	List<SectionHistory> sh = PenaleDAO.getInstance().getPenaleHistBySocialCardId(socialCardId);
