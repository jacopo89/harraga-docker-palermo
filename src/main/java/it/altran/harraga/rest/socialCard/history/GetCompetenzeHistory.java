...
public class GetCompetenzeHistory extends ActionSupport implements ServletRequestAware  {
    ...
    public String execute() {  	
    	...
    	List<SectionHistory> sh = CompetenzeDAO.getInstance().getCompetenzeHistBySocialCardId(socialCardId);
