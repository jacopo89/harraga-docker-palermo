...
public class GetIstruzioneHistory extends ActionSupport implements ServletRequestAware  {
    ...
    public String execute() {  	
    	...
    	List<SectionHistory> sh = IstruzioneDAO.getInstance().getIstruzioneHistBySocialCardId(socialCardId);
