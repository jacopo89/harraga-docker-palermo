...
public class GetLavoroHistory extends ActionSupport implements ServletRequestAware  {
    ...
    public String execute() {  	
    	...
    	List<SectionHistory> sh = LavoroDAO.getInstance().getLavoroHistBySocialCardId(socialCardId);
