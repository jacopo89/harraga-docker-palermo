...
public class GetSanitariaHistory extends ActionSupport implements ServletRequestAware  {
    ...
    public String execute() {  	
    	...
    	List<SectionHistory> sh = SanitariaDAO.getInstance().getSanitariaHistBySocialCardId(socialCardId);
