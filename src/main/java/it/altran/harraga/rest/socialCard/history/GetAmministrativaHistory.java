...
public class GetAmministrativaHistory extends ActionSupport implements ServletRequestAware  {
    ...
    public String execute() {  	
    	...
    	List<SectionHistory> sh = AmministrativaDAO.getInstance().getAmministrativaHistBySocialCardId(socialCardId);
