...
public class PermissionMap {
	...
	private PermissionMap() {
		...
		permessi = new Permission(read, write);
		permissonMap.put(Ruolo.COMUNE_PALERMO, permessi);
	...
	public boolean isIstitutional(Ruolo ruolo) {
	    /*
		if (ruolo == User.Ruolo.COMUNE_PALERMO || ruolo == User.Ruolo.CPA || ruolo == User.Ruolo.RESP_SEC_ACC || ruolo == User.Ruolo.ASP || ruolo == User.Ruolo.CPIA || ruolo == User.Ruolo.USSM
				|| ruolo == User.Ruolo.GARANTE || ruolo == User.Ruolo.ITASTRA)
			return true;
		return false;
		*/
        if (ruolo == Ruolo.COMUNE_PALERMO  || ruolo == Ruolo.ASP || ruolo == Ruolo.CPIA || ruolo == Ruolo.USSM
	...
	public boolean canCreate(Ruolo ruolo) {
		if (ruolo == Ruolo.CPA || ruolo == Ruolo.RESP_SEC_ACC || ruolo == Ruolo.COMUNE_PALERMO)
			return true;
		return false;
	}
