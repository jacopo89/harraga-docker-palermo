    ...
    if ($languageKeyAliases) {
      ...
      for (var langKeyAlias in $languageKeyAliases) {
        if ($languageKeyAliases.hasOwnProperty(langKeyAlias)) {
          ...
          var hasessoactKey = Object.prototype.hasOwnProperty.call($languageKeyAliases, langKeyAlias) &&
            angular.lowercase(langKeyAlias) === angular.lowercase(preferred);

          if (langKeyAlias.slice(-1) === '*') {
            hasWildcardKey = langKeyAlias.slice(0, -1) === preferred.slice(0, langKeyAlias.length - 1);
          }
          if (hasessoactKey || hasWildcardKey) {
...
function translateDirective($translate, $q, $interpolate, $compile, $parse, $rootScope) {
  ...
  return {
    ...
    compile: function (tElement, tAttr) {
      ...
      var translateValuesessoist = (tAttr.translateValues) ?
      ...
      return function linkFn(scope, iElement, iAttr) {
        ...
        if (translateValuesessoist || translateValueExist || iAttr.translateDefault) {
